...
type Brand = 'hallmark' | 'lifetime' | 'gaf' | 'uptv';
...
const brandLabels: Record<Brand, string> = { hallmark: 'Hallmark', lifetime: 'Lifetime', gaf: 'Great American Family', uptv: 'UPtv' };
